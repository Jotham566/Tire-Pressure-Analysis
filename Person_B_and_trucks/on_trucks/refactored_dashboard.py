...
def main():
    st.set_page_config(
        page_title="Tire Sound Data Dashboard (Person B)",
        page_icon="🚗",
        layout="wide",
    ...
    st.markdown("<h1 style='text-align: center; color: #1f77b4;'><i class='fas fa-tachometer-alt'></i> Tire Sound Data Dashboard (Person B: Tread - Strong)</h1>", unsafe_allow_html=True)
    ...
    def get_available_pressures_and_segments(data_dir, wheel_directory, hitting_directory, pair, selected_hitting_type):
        ...
        for pos in pair:
            try:
                ...
                file_pattern = f"Strong Tread Time Domain segment *-POS-POS{pos}.xlsx"
