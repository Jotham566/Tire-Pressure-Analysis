...
FULL_SEGMENTS_FOLDER = "abcd@10輪車-打音_5Hits_SideStrong_BestCase"
BASE_OUTPUT_FOLDER = "Processed_CSV_Files(abcd@10_SideStrong-Best)"
TRUCK_WHEEL_FOLDERS = {
    '6W': "6 wheels",
    '10W': "10 wheels",
    '12W': "12 wheels"
...
def count_files_in_directory(directory):
    ...
    try:
        segments_dir = os.path.join(directory, "Strong-Side Time-Domain Segments")
...
def process_hit(samples, hit_segment, desired_length=DESIRED_LENGTH):
    ...
    # Normalize again so that the sum of the truncated or padded segment is 1
...
def save_to_csv(file_info: Dict[str, str], segments: List[np.ndarray], base_output_dir: str):
    ...
    base_output_dir/[wheel_type]/Strong-Side Time-Domain Segments/[csv_files]
    """
    ...
    segments_dir = os.path.join(wheel_dir, "Strong-Side Time-Domain Segments")
    ...
    # Create filename: Strong Side Time Domain segment pressure-POS-{position}.csv
    filename = f"Strong Side Time Domain segment {file_info['pressure']}-POS-{file_info['position']}.csv"
